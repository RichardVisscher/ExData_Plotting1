...
## PLOTTING THE DATA
## Make histogram "Global Active Power", plot1
hist(power$Global_active_power, cex.axis=0.75, cex.lab=0.75, col = "red", main = "Global Active Power",xlab = "Global active Power (kilowatts)")
